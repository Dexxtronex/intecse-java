...
public class Inventario11 extends javax.swing.JFrame implements Printable{
...
public Inventario11(int j) {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            Logger.getLogger(Inventario11.class.getName()).log(Level.SEVERE, null,ex);
        }
