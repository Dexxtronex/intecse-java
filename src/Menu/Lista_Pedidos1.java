 ...
 * @author anthony
 */
public class Lista_Pedidos1 extends javax.swing.JFrame implements Printable {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lista_Pedidos1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lista_Pedidos1().setVisible(true);
            }
        });
    }
