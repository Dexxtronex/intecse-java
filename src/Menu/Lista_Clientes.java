...
public class Lista_Clientes extends javax.swing.JFrame {
    ...
    Form_Clientes forc  = new Form_Clientes(1,1);
    ...
    {  
        ...
        forc.CmbProvincia.setEnabled(true);
        forc.CmbSex.setEnabled(true);
        ModDeshabilito();
 ...
 String x;
      ...
      x = y.Fecha();
        ...
        fila1.createCell(0).setCellValue("Reporte Lista Clientes");
        ...
        fila.createCell(1).setCellValue("C.I");
        fila.createCell(2).setCellValue("Nombre");
        fila.createCell(3).setCellValue("Apellido");
        fila.createCell(4).setCellValue("Direccion");
        fila.createCell(5).setCellValue("Correo");
        fila.createCell(6).setCellValue("Sexo");
        fila.createCell(7).setCellValue("Celular");
        fila.createCell(8).setCellValue("Telefono");
        fila.createCell(9).setCellValue("Fecha_Nacimiento");
        fila.createCell(10).setCellValue("Provincia");
        ...
        for(int i = 0; i <tabla.getRowCount(); i++){
            ...
            filas.createCell(10).setCellValue(tabla.getValueAt(i, 10).toString());

        }
        try{
            workbook.write(new FileOutputStream(new File(ruta+"//Reporte_Lista_Clientes.xlsx")));
            Desktop.getDesktop().open(new File(ruta+"//Reporte_Lista_Clientes.xlsx"));
        }catch (Exception ex){
