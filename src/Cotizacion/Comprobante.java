...
public class Comprobante extends javax.swing.JFrame {
    ...
    public Comprobante() {
        ...
        setDefaultCloseOperation(Comprobante.DISPOSE_ON_CLOSE);
        cargar_datos();
    ...
    public void cargar_datos()
    {
       ...
       try
       {
           PreparedStatement pst = link.prepareStatement("SELECT * FROM comprobante");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 50, -1, 51));
    ...
    public void filtrar()
    {
        ...
        else
        {
            ...
            try
            {
                PreparedStatement pst = link.prepareStatement("SELECT * FROM comprobante WHERE Fecha LIKE '%/"+recogedor+"/%'");
                ResultSet rs = pst.executeQuery();
                while(rs.next())
                {
                  arreglo[0] = rs.getString(1);
    ...
    {
        Comprobante_Cotizacion factu = new Comprobante_Cotizacion();
        ...
        try
        {
            ...
            modelo.addColumn("TOTAL");     
            PreparedStatement pst = link.prepareStatement("SELECT * FROM detalle_comprobante WHERE Num_Factura = '"+num_factura+"'");
            ResultSet rs = pst.executeQuery();
            while(rs.next())
            {
